...
" =============== 代码，跳转 g ==================
map  gi                  :<C-u>call VSCodeNotify('editor.action.goToImplementation')<CR>
...
" =============== 搜索相关 g ==================
map  <leader>ff          :<C-u>call VSCodeNotify('workbench.action.findInFiles', { 'query': expand('<cword>')})<CR>
